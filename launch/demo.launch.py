# Single-window demo: map server + headless robot/laser publisher + viewer.
...
def generate_launch_description():
    ...
    demo_robot_node = Node(
        package="rp_simple_rviz",
        executable="demo_robot_node",
        name="demo_robot_node",
        output="screen",
        parameters=[
            {
                "robot_frame": "robot_1",
                "laser_frame": "laser_1",
                "scan_topic": "/laser_1/scan",
                "cmd_vel_topic": "/robot_1/cmd_vel",
                "robot_x": 18.0,
                "robot_y": -25.0,
                "robot_yaw": 0.0,
                "laser_angle_min": -1.57079632679,
                "laser_angle_max": 1.57079632679,
            }
        ],
    )
